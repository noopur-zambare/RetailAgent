# RetailAgent
AI-powered Canadian Retail Intelligence System using Statistics Canada datasets, PostgreSQL, and LLM-based reasoning. RetailAgent is an intelligent business analytics assistant that helps users explore and understand Canadian retail trade data using natural language.

It combines:

- 📊 Structured SQL database (PostgreSQL)
...
- SQL-based structured data storage (PostgreSQL)
